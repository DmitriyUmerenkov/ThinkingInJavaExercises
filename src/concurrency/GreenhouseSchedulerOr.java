...
public class GreenhouseSchedulerOr {
...
class CollectData extends DelayedRunnable{
  ...
  public void run() {
    ...
    synchronized(GreenhouseSchedulerOr.this) {
...
humidityDirection * rand.nextFloat();
  ...
  public static void main(String[] args) {
    GreenhouseSchedulerOr gh = new GreenhouseSchedulerOr();
    gh.schedule(gh.new Terminate(0), 5000);
    // Former "Restart" class not necessary:
    gh.repeat(gh.new Bell(0), 0, 1000);
    gh.repeat(gh.new ThermostatNight(0), 0, 2000);
    gh.repeat(gh.new LightOn(0), 0, 200);
    gh.repeat(gh.new LightOff(0), 0, 400);
    gh.repeat(gh.new WaterOn(0), 0, 600);
    gh.repeat(gh.new WaterOff(0), 0, 800);
    gh.repeat(gh.new ThermostatDay(0), 0, 1400);
    gh.repeat(gh.new CollectData(0), 500, 500);
  }
}
